                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-5 fv-row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-4">
                                                        <input type="text" name="name[fa]" value="{{ old('name.fa', isset($subAmenity) ? $subAmenity->getTranslation('name', 'fa') : '') }}" class="form-control mb-2" placeholder="الاسم بالفارسية" />
                                                    </div>
                                                </div>
                                                <!--end::Input-->
                                            </div>
                                                    ...
                                                    @if(old('options.ar') || isset($subAmenity) && ($subAmenity->type == 'select' || $subAmenity->type == 'multiselect'))
                                                        @foreach(old('options.ar', $subAmenity->options ?? []) as $index => $option)
                                                            <div class="d-flex mb-2">
                                                                ...
                                                                <input type="text" name="options[fa][]" class="form-control" placeholder="الخيار بالفارسية" value="{{ old('options.fa.' . $index, $option->getTranslations('name')['fa'] ?? '') }}" />
    ...
    <script>
        ...
        document.getElementById('add-option').addEventListener('click', function () {
            ...
            newOption.innerHTML = `
                ...
                <input type="text" name="options[en][]" class="form-control me-2" placeholder="الخيار بالإنجليزية" />
               <input type="text" name="options[fa][]" class="form-control" placeholder="الخيار بالفارسية" />
