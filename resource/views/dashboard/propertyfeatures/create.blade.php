                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="kt_ecommerce_add_neighborhood_ar" role="tabpanel">
                                ...
                                <select name="type" class="form-select mb-2">
                                    <option value="internal" {{ old('type', isset($row) && $row->type == 'internal' ? 'selected' : '') }}>داخلى</option>
                                    <option value="external" {{ old('type', isset($row) && $row->type == 'external' ? 'selected' : '') }}>خارجى</option>
                                </select>
                            </div>
                                        </div>
                                        <!--end::Card header-->
