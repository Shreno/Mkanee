                    ...
                    <div class="row">                      
                        <div class="col-lg-12">
                            <div class="title-inner style">
                                <div class="title-group fs-12"><a class="home fw-6 text-color-6" href="index.html">الرئيسية</a><span >من نحن</span></div>
                            </div>
                        </div> 
                    </div>
                </div>
                    ...
                    <div class="row">                      
                        <div class="col-lg-7 col-md-7">
                            <div class="heading-about">
                                <h2>حياة أفضل مع منزل أفضل</h2>
                                <h4>عيش حياة أفضل يبدأ من اختيار المنزل المثالي. من خلال توفير بيئات سكنية مريحة وملهمة، نساعدك في خلق مساحة تعزز من رفاهيتك وسعادتك.</h4>
                                <p class="text-1 text-color-2">منزلك هو قلب حياتك، واستثمارك في منزل أفضل يعني استثمارك في جودة حياتك. نقدم لك خيارات سكنية تتناسب مع احتياجاتك وتوفر لك الراحة والأمان. </p>
                                <div class="text-box">
                                    <p class="font-2 fw-5 font-italic text-color-2">إن الاستثمار في منزل ممتاز هو خطوة أساسية نحو تحسين جودة حياتك. بفضل خبرتنا وشغفنا في تقديم الأفضل، نعدك بأن كل منزل نعرضه سيعزز من رفاهيتك ويجعل حياتك أكثر إشراقًا.</p>
                                </div>
                                <div class="author-box">
                                    <h3>Ralph Edwards</h3>
                                    <p>الرئيس التنفيذي والمؤسس المشارك</p>
                                ...
                                <div class="post-video flex-five">      
                                    ...
                                    <a href="#" class="lightbox-image">                              
                                        <svg width="11" height="14" viewBox="0 0 11 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M11 7L3.41715e-07 14L9.53674e-07 -4.80825e-07L11 7Z" fill="#2C8FDB"/>
                                        </svg>
                                        <i class="ripple"></i>
                                    </a>
                                </div>
                    ...
                    <div class="row">                      
                        <div class="col-lg-12">
                            <div class="heading-section center">
                                ...
                                <p class="text-1 text-color-4">نقدم حلولاً متكاملة لجميع احتياجاتك العقارية بطرق احترافية وفعالة.</p>
                            </div>
                        </div>
                    ...
                    <div class="row">                      
                        <div class="col-lg-12">
                            <div class="title-section center">
                                <h4>موثوق به من قبل أكثر من 150 شركة كبرى</h4>
                            </div>
            ...
            <section class="flat-search-home page" >
                <div class="container">
                    <div class="row">                      
                        <div class="col-lg-12">
                            <div class="heading-section center">
                                <h2 class="fw-8 font-2 lh-56">نحن نقدم لك العقارات الأكثر ملاءمة و جودة.</h2>
                                <p class="">نحن نقدم لك العقارات التي تجمع بين الجودة العالية والملاءمة المثلى لتلبية احتياجاتك.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <div class="box-icon flex align-center">
                                ...
                                <div class="content">
                                    <p class="text-1 fw-6">عنوان المكتب</p>
                                    <div class="fs-16 lh-24">2715 Ash Dr. سان خوسيه، داكوتا الجنوبية 83475</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <div class="box-icon flex align-center">
                                ...
                                <div class="content">
                                    <p class="fw-6">طلب إعادة الاتصال</p>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box-icon flex align-center">
                                ...
                                <div class="content">
                                    <p class="text-3  fw-6">راسلنا عبر البريد الالكترونى</p>
                                    ...
                                    <form method="post" id="contactform" class="comment-form form-submit"
                                        ...
                                        <div class="text-wrap flex form-wg">
                                            <fieldset class="info-box">
                                                <label class="fw-6">الاسم كامل</label>
                                                <input type="text" class="tb-my-input" name="text" placeholder="الاسم كامل" required="">
                                            </fieldset>
                                            <fieldset class="info-box">
                                                <label class="fw-6">الايميل أو الهاتف</label>
                                                <input type="email" class="tb-my-input" name="email" placeholder="الايميل أو الهاتف" required="">
                                            </fieldset>
                                            <div class="info-box">
                                                <label class="fw-6">نوع العقار</label>
                                                <div class="nice-select relative" tabindex="0"><span class="current">اختر</span>
                                                    <ul class="list style">                                                          
                                                      <li data-value class="option selected">اختر</li>
                                                      <li data-value="America" class="option">شقة</li>
                                                      <li data-value="England" class="option">منزل</li>                                                                  
                                                      <li data-value="VietNam" class="option">ايجار</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
            ...
            <section class="flat-meet page-about" >
                <div class="container">
                    <div class="row">                      
                        <div class="col-lg-12">
                            <div class="heading-section center">
                                <h2>تعرف على الوكلاء</h2>
                                <p class="text-color-4">تعرف على وكلائنا المحترفين، الذين سيساعدونك في العثور على أفضل الخيارات لاحتياجاتك العقارية.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <div class="box hover-img">
                                <div class="images relative img-style">
                                    <a href="#"><img src="assets/images/img-box/meet-4.jpg" alt="images"></a>
                                ...
                                <div class="content flex justify-space">
                                    <div class="inner">
                                        <h3 class="link-style-1"><a href="#">Wade Warren</a></h3>
                                        <p class="fs-12 text-color-2">مندوب مبيعات</p>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box hover-img">
                                <div class="images relative img-style">
                                    <a href="#"><img src="assets/images/img-box/meet-5.jpg" alt="images"></a>
                                    <div class="icon-socials">
                                        <a href="#"><i class="fab fa-facebook-f"></i></a>
                                        <a href="#"><i class="fab fa-twitter"></i></a>
                                        <a href="#"><i class="fab fa-linkedin-in"></i></a>
                                ...
                                <div class="content flex justify-space">
                                    <div class="inner">
                                        <h3 class="link-style-1"><a href="#">Leslie Alexander</a></h3>
                                        <p class="fs-12 text-color-2">سمسار تجاري</p>
                                    </div>
                                    <div class="icon-box flex">
                                        <a href="#"><i class="fas fa-phone-alt"></i></a>
                                        <a href="#"><i class="fas fa-envelope"></i></a>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box hover-img">
                                <div class="images relative img-style">
                                    <a href="#"><img src="assets/images/img-box/meet-6.jpg" alt="images"></a>
                                    <div class="icon-socials">
                                        <a href="#"><i class="fab fa-facebook-f"></i></a>
                                        <a href="#"><i class="fab fa-twitter"></i></a>
                                        <a href="#"><i class="fab fa-linkedin-in"></i></a>
                                ...
                                <div class="content flex justify-space">
                                    <div class="inner">
                                        <h3 class="link-style-1"><a href="#">Darlene Robertson</a></h3>
                                        <p class="fs-12 text-color-2">سمسار عقارات</p>
                                    </div>
                                    <div class="icon-box flex">
                                        <a href="#"><i class="fas fa-phone-alt"></i></a>
                                        <a href="#"><i class="fas fa-envelope"></i></a>
                        ...
                        <div class="col-lg-12">
                            <div class="box-text flex justify-center">
                                <p>كن وكيلًا واحصل على العمولة التي تستحقها.</p> <a href="#" class="text-color-6 font-2 fw-7"> تواصل معنا</a>
                            </div>
