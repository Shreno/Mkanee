...
; (function ($) {
    ...
    var retinaLogos = function() {
        var retina = window.devicePixelRatio > 1 ? true : false;
            if(retina) {
                $('#site-logo-inner').find('img').attr( {src:'assets/images/logo/loading.PNG',width:'197',height:'48'} );
            }   
        };
    ...
    const sticky = function () {
        ...
        if (stickyElTop < scrollTop + 20 && (scrollTop + stickEl.outerHeight() < footerTop)) {
