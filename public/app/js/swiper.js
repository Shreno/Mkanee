...
$(document).ready(function() {
    ...
    const $rtlStyles = $('#rtl-style, #rtl-style-two');

    if (dir === 'rtl') {
        $rtlStyles.each(function() {
...
$(document).ready(function() {
    ...
    if (lang === 'ar' || (!lang && $('html').attr('dir') === 'rtl')) {
        $('html').attr('dir', 'rtl');
        $('.cart-count').hide(); // Hide both initially
    ...
    $('#cart-icon').on('click', function(event) {
        ...
        // Toggle language and update HTML direction
        if ($('html').attr('dir') === 'rtl') {
            // Switch to LTR
            $('html').removeAttr('dir'); // Remove direction attribute
