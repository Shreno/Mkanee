...
@section('pageTitle' , isset($row) ? __('dashboard.edit_title', ['page_title' => __('dashboard.primary-amenities')]) : __('dashboard.create_title', ['page_title' => __('dashboard.primary-amenities')]))
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <!--begin::Form-->
                <form id="kt_ecommerce_add_product_form" action="{{ isset($row) ? route('primary-amenities.update', $row->id) : route('primary-amenities.store') }}" method="POST"
                    class="form d-flex flex-column flex-lg-row store" data-kt-redirect="{{route('primary-amenities.index')}}" enctype='multipart/form-data'>
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{ route('primary-amenities.index') }}" id="kt_ecommerce_add_product_cancel"
