                        ...
                        <div class="row">                      
                            <div class="col-lg-12">
                                <div class="heading-section center">
                                    <h2> @lang('website.properties_for_sale')</h2>
                                    <p class="text-color-4">  @lang('website.best_deals_now')</p>
                                </div>
                                @include('website.pages.home_section.property')

                                <div class="sale-button center mt-50">
                                    <a href="{{route('all-properties.index')}}" class="sc-button style-2">
                                        ...
                                        <span>                            @lang('website.view_all_properties') 
                                        </span>
                                    </a>
                                </div>  
                            </div>
